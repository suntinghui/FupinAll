...
public class MainTypeAdapterVideo extends BaseQuickAdapter<VodTypeBean, BaseViewHolder> {

    private List<VodTypeBean> mList = new ArrayList<>();
    private IMainTopListener mListener;

    public MainTypeAdapterVideo(IMainTopListener listener) {
...
//        drawable.setCornerRadius(MyConstants.Setting.CORNER_COMMON);
        MyUtil.setOnFocusListenerType(mContext, helper.getView(R.id.fl_main_layout), helper.getView(R.id.tv_item_tip));

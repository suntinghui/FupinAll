...
public class SearchPublishTimeAdapter extends BaseQuickAdapter<SearchPublishTimeBean, BaseViewHolder> {

    private List<SearchPublishTimeBean> mList = new ArrayList<>();

    public SearchPublishTimeAdapter() {
    ...
    @Override
    protected void convert(final BaseViewHolder helper, final SearchPublishTimeBean bean) {
        helper.setText(R.id.tv_item, bean.getPublishTime());
    ...
    public void addAllData(List<SearchPublishTimeBean> dataList) {
        this.mList = dataList;

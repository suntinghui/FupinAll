...
public class CacheFileBeanDao extends AbstractDao<CacheFileBean, Long> {
    ...
    public static class Properties {
        ...
        public final static Property OriginFileName = new Property(3, String.class, "originFileName", false, "ORIGIN_FILE_NAME");
        ...
        public final static Property VideoId = new Property(8, String.class, "videoId", false, "VIDEO_ID");
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"CACHE_FILE_BEAN\" (" + //
                ...
                "\"ORIGIN_FILE_NAME\" TEXT," + // 3: originFileName
    ...
    protected final void bindValues(DatabaseStatement stmt, CacheFileBean entity) {
        ...
        String originFileName = entity.getOriginFileName();
        if (originFileName != null) {
            stmt.bindString(4, originFileName);
        }
    ...
    public CacheFileBean readEntity(Cursor cursor, int offset) {
        CacheFileBean entity = new CacheFileBean( //
            ...
            cursor.isNull(offset + 3) ? null : cursor.getString(offset + 3), // originFileName
            ...
            cursor.isNull(offset + 8) ? null : cursor.getString(offset + 8), // videoId
    ...
    public void readEntity(Cursor cursor, CacheFileBean entity, int offset) {
        ...
        entity.setOriginFileName(cursor.isNull(offset + 3) ? null : cursor.getString(offset + 3));
        ...
        entity.setVideoId(cursor.isNull(offset + 8) ? null : cursor.getString(offset + 8));

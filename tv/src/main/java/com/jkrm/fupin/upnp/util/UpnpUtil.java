...
public class UpnpUtil {
    ...
    public static UDN uniqueSystemIdentifier(String salt) {
        ...
        Log.d(TAG,  "host:" + MyApp.getHostName() + " ip:" +   MyApp.getHostAddress());
        if (null != MyApp.getHostName()
                && null != MyApp.getHostAddress()) {
            systemSalt.append(MyApp.getHostName()).append(
                    MyApp.getHostAddress());
        }

...
package com.jkrm.fupin.upnp.dms;

import android.app.Activity;
import android.os.Handler;

import com.jkrm.fupin.upnp.com.zxt.dlna.activity.ContentActivity;
			...
			public void run() {
				try {
					...
					for (Item childItem : didl.getItems()) {
						MyLog.d("add child item" + childItem.getTitle());
